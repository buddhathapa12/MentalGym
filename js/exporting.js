...
(function(g) {
    ...
    function n(e, f, g, l) { e.hasOwnProperty(f) || (e[f] = l.apply(null, g)) }
    g = g ? g._modules : {};
        ...
        var l = function() {
            ...
            e.prototype.open = function() {
                var k =
                    ...
                    e = k.chart;
                if (k.browserProps) {
                    k.unbindFullscreenEvent = g(e.container.ownerDocument, k.browserProps.fullscreenChange, function() { k.isOpen ? (k.isOpen = !1, k.close()) : (k.isOpen = !0, k.setButtonText()) });
                    var f = e.renderTo[k.browserProps.requestFullscreen]();
                    if (f) f["catch"](function() { alert("Full screen is not supported inside a frame.") });
            ...
            e.prototype.toggle = function() { this.isOpen ? this.close() : this.open() };
            return e
        }();
        e.Fullscreen = l;
        g(f, "beforeRender", function() { this.fullscreen = new e.Fullscreen(this) });
        return e.Fullscreen
    });
    n(g, "mixins/navigation.js", [], function() {
        return {
            initUpdate: function(e) { e.navigation || (e.navigation = { updates: [], update: function(e, g) { this.updates.forEach(function(f) { f.update.call(f.context, e, g) }) } }) },
    ...
    n(g, "modules/exporting.src.js", [g["parts/Globals.js"], g["parts/Utilities.js"], g["mixins/navigation.js"]], function(e, f, g) {
        ...
        r(!0, v.navigation, { buttonOptions: { theme: {}, symbolSize: 14, symbolX: 12.5, symbolY: 10.5, align: "right", buttonSpacing: 3, height: 22, verticalAlign: "top", width: 24 } });
        r(!0, v.navigation, {
            menuStyle: { border: "1px solid #999999", background: "#ffffff", padding: "5px 0" },
            menuItemStyle: { padding: "0.5em 1em", color: "#333333", background: "none", fontSize: M ? "14px" : "11px", transition: "background 250ms, color 250ms" },
        ...
        e.post = function(a, b, c) {
            var d = k("form", r({ method: "post", action: a, enctype: "multipart/form-data" }, c), { display: "none" }, x.body);
            E(b, function(a, b) { k("input", { type: "hidden", name: b, value: a }, null, d) });
            d.submit();
            n(d)
        };
        e.isSafari && e.win.matchMedia("print").addListener(function(a) { e.printingChart && (a.matches ? e.printingChart.beforePrint() : e.printingChart.afterPrint()) });
        w(B.prototype, {
            ...
            getSVG: function(a) {
                ...
                var d = k("div",
                    null, { position: "absolute", top: "-9999em", width: this.chartWidth + "px", height: this.chartHeight + "px" }, x.body);
                ...
                this.series.forEach(function(a) {
                    b =
                        r(a.userOptions, { animation: !1, enableMouseTracking: !1, showCheckbox: !1, visible: a.visible });
                ...
                this.axes.forEach(function(a) {
                    var b = I(u.axes, function(b) { return b.options.internalKey === a.userOptions.internalKey }),
                        d = a.getExtremes(),
                        c = d.userMin;
                    d = d.userMax;
                    b && ("undefined" !==
            ...
            getSVGForExport: function(a, b) { var c = this.options.exporting; return this.getSVG(r({ chart: { borderRadius: 0 } }, c.chartOptions, b, { exporting: { sourceWidth: a && a.sourceWidth || c.sourceWidth, sourceHeight: a && a.sourceHeight || c.sourceHeight } })) },
            ...
            print: function() {
                ...
                a.isPrinting || (e.printingChart = a, e.isSafari || a.beforePrint(), setTimeout(function() {
                    y.focus();
                    y.print();
                    e.isSafari || setTimeout(function() { a.afterPrint() }, 1E3)
                }, 1))
            },
            contextMenu: function(a, b, c, d, e, g, u) {
                ...
                if (!m) {
                    ...
                    h.styledMode || q(n, w({ MozBoxShadow: "3px 3px 10px #888", WebkitBoxShadow: "3px 3px 10px #888", boxShadow: "3px 3px 10px #888" }, D.menuStyle));
                    m.hideMenu = function() {
                        q(m, { display: "none" });
                        u && u.setState(0);
                        h.openMenu = !1;
                    ...
                    h.exportEvents.push(l(m, "mouseleave", function() { m.hideTimer = y.setTimeout(m.hideMenu, 500) }), l(m, "mouseenter", function() { f.clearTimeout(m.hideTimer) }),
                        l(x, "mouseup", function(b) { h.pointer.inClass(b.target, a) || m.hideMenu() }), l(m, "click", function() { h.openMenu && m.hideMenu() }));
                    b.forEach(function(a) {
                        ...
                        if (J(a, !0)) {
                            ...
                            }, b.onmouseout = function() { q(this, D.menuItemStyle) }, q(b, w({ cursor: "pointer" }, D.menuItemStyle)));
            ...
            addButton: function(a) {
                ...
                if (!1 !== d.enabled) {
                    ...
                    d.text && d.symbol ? h.paddingLeft = t(h.paddingLeft, 25) : d.text || w(h, { width: d.width, height: d.height, padding: 0 });
            ...
            destroyExport: function(a) {
                ...
                a && (a.forEach(function(a,
                    d) { a && (a.onclick = a.ontouchstart = null, e = "cache-" + a.menuClassName, b[e] && delete b[e], b.exportSVGElements[d] = a.destroy()) }), a.length = 0);
